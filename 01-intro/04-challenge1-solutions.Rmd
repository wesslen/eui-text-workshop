...
Our goal is to learn how to filter a dataset. The goal: find Carolina Panther Tweets.

1. Run the `functions.R` file with pre-created functions. Read in the data. 
...
raw.tweets <- read.csv("CharlotteTweets20Sample.csv", stringsAsFactors = F)
source("functions.R")
...
Determine how many Panther Tweets you can identify for this period. 
